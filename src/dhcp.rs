...
pub struct NetworkConfig {
    pub ip_address: String, // IPv4
    pub subnet_cidr: u8,
    pub network_number: String, // IPv4

    pub routers: String, // List of IPv4?
    pub dns_servers: String, // List of IPv4?
}
...
pub fn read_network_config() -> Result<NetworkConfig> {
    let ip_address = env::var("new_ip_address")?;
...
pub fn run_dhcpcd(interface: &str, hook: &str) -> Result<()> {
